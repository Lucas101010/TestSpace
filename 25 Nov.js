...
if(timeline.length > 0){
    ...
    text_4.innerHTML = "Please submit any questions you'd like us to address before the event starts here." + '<a href="https://www.google.com"' + ' target="_blank" ' +  '> O </a>';
    text_4.style = "color : white ";
    top.appendChild(text_4);
    
    var text_5 = document.createElement("p");
    text_5.innerHTML = "라이브 Q&A 세션에서 질문하실 내용이 있는 경우, 행사 시작 전에 여기에 올려주시기 바랍니다." + '<a href="https://www.google.com"' + ' target="_blank" ' +  '> O </a>';
    text_5.style = "color : white ";
    top.appendChild(text_5);
    
    var text_6 = document.createElement("p");
    text_6.innerHTML = "イベント開始前のライブQ&Aでお尋ねになりたいことがありましたら、こちらからお寄せください" + '<a href="https://www.google.com"' + ' target="_blank" ' +  '> O </a>';
