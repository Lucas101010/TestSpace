...
if(timeline.length > 0){
    ...
    text_1.innerHTML = "On-demand videos are available now."
    //text_1.innerHTML = "On-demand videos will be accessible from " + '<a style="color : yellow;">8 December 2020</a>' + " onwards."
    text_1.style = "color : white; padding-top : 20px; font-weight : bold; font-size : 20px;";
    top.appendChild(text_1);
    
    var text_2 = document.createElement("p");
    text_2.innerHTML = "オンデマンドビデオが利用可能になりました。"
    //text_2.innerHTML = "オンデマンドビデオは" + '<a style="color : yellow;">2020年12月8日</a>' + "からアクセス可能になります。"
    text_2.style = "color : white; font-weight : bold; font-size : 20px;";
    top.appendChild(text_2);
    
    var text_3 = document.createElement("p");
    text_3.innerHTML = "이제 주문형 비디오를 사용할 수 있습니다."
    //text_3.innerHTML = "주문형 비디오는 " + '<a style="color : yellow;">2020 년 12 월 8 일</a>' + "부터 액세스 할 수 있습니다."
    text_3.style = "color : white; font-weight : bold; font-size : 20px;";
